...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BalanceReload);
}
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$BalanceErrorStateCopyWith<_BalanceErrorState> get copyWith => __$BalanceErrorStateCopyWithImpl<_BalanceErrorState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BalanceErrorState&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
/// @nodoc
abstract mixin class _$BalanceErrorStateCopyWith<$Res> implements $BalanceStateCopyWith<$Res> {
  factory _$BalanceErrorStateCopyWith(_BalanceErrorState value, $Res Function(_BalanceErrorState) _then) = __$BalanceErrorStateCopyWithImpl;
@override @useResult
$Res call({
 int balance, String errorMessage
});
...
/// Create a copy of BalanceState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? balance = null,Object? errorMessage = null,}) {
