...
class ProductStarted implements ProductEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ProductStarted);
  }
...
class ProductReload implements ProductEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ProductReload);
  }
...
class _ProductState implements ProductState {
  const _ProductState({required final List<Product> products})
      : _products = products;
...
class _ProductErrorState implements ProductState {
  const _ProductErrorState(
      {required final List<Product> products, required this.errorMessage})
      : _products = products;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProductErrorStateCopyWith<_ProductErrorState> get copyWith =>
      __$ProductErrorStateCopyWithImpl<_ProductErrorState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProductErrorState &&
            const DeepCollectionEquality().equals(other._products, _products) &&
...
/// @nodoc
abstract mixin class _$ProductErrorStateCopyWith<$Res>
    implements $ProductStateCopyWith<$Res> {
  factory _$ProductErrorStateCopyWith(
          _ProductErrorState value, $Res Function(_ProductErrorState) _then) =
      __$ProductErrorStateCopyWithImpl;
  @override
  @useResult
  $Res call({List<Product> products, String errorMessage});
}
