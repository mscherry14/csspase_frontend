...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderStarted);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderReload);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderState&&const DeepCollectionEquality().equals(other._orders, _orders));
}
...
class _OrderErrorState implements OrderState {
  const _OrderErrorState({required final  List<Order> orders, required this.errorMessage}): _orders = orders;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$OrderErrorStateCopyWith<_OrderErrorState> get copyWith => __$OrderErrorStateCopyWithImpl<_OrderErrorState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderErrorState&&const DeepCollectionEquality().equals(other._orders, _orders)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_orders),errorMessage);
...
/// @nodoc
abstract mixin class _$OrderErrorStateCopyWith<$Res> implements $OrderStateCopyWith<$Res> {
  factory _$OrderErrorStateCopyWith(_OrderErrorState value, $Res Function(_OrderErrorState) _then) = __$OrderErrorStateCopyWithImpl;
@override @useResult
$Res call({
 List<Order> orders, String errorMessage
});
...
/// Create a copy of OrderState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? orders = null,Object? errorMessage = null,}) {
  return _then(_OrderErrorState(
orders: null == orders ? _self._orders : orders // ignore: cast_nullable_to_non_nullable
as List<Order>,errorMessage: null == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
