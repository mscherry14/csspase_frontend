...
abstract mixin class $InitEventCopyWith<$Res>
  ...
  factory $InitEventCopyWith(InitEvent value, $Res Function(InitEvent) _then) =
      _$InitEventCopyWithImpl;
  @useResult
...
class ConfirmPurchaseEvent implements PurchaseEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ConfirmPurchaseEvent);
  }
...
class ProductErrorState implements PurchaseState {
  ...
  $ProductErrorStateCopyWith<ProductErrorState> get copyWith =>
      _$ProductErrorStateCopyWithImpl<ProductErrorState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProductErrorState &&
...
/// @nodoc
abstract mixin class $ProductErrorStateCopyWith<$Res>
    implements $PurchaseStateCopyWith<$Res> {
  factory $ProductErrorStateCopyWith(
          ProductErrorState value, $Res Function(ProductErrorState) _then) =
      _$ProductErrorStateCopyWithImpl;
  @useResult
...
class WaitForConfirmationState implements PurchaseState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WaitForConfirmationStateCopyWith<WaitForConfirmationState> get copyWith =>
      _$WaitForConfirmationStateCopyWithImpl<WaitForConfirmationState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WaitForConfirmationState &&
...
/// @nodoc
abstract mixin class $WaitForConfirmationStateCopyWith<$Res>
    implements $PurchaseStateCopyWith<$Res> {
  factory $WaitForConfirmationStateCopyWith(WaitForConfirmationState value,
          $Res Function(WaitForConfirmationState) _then) =
      _$WaitForConfirmationStateCopyWithImpl;
  @useResult
...
class PurchaseSuccessState implements PurchaseState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PurchaseSuccessState);
  }
...
class PurchaseErrorState implements PurchaseState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PurchaseErrorStateCopyWith<PurchaseErrorState> get copyWith =>
      _$PurchaseErrorStateCopyWithImpl<PurchaseErrorState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PurchaseErrorState &&
            (identical(other.message, message) || other.message == message));
  }
...
/// @nodoc
abstract mixin class $PurchaseErrorStateCopyWith<$Res>
    implements $PurchaseStateCopyWith<$Res> {
  factory $PurchaseErrorStateCopyWith(
          PurchaseErrorState value, $Res Function(PurchaseErrorState) _then) =
      _$PurchaseErrorStateCopyWithImpl;
  @useResult
  $Res call({String? message});
}
