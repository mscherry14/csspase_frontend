...
mixin _$EventsState {
 ...
 List<EventShortModel> get events;
...
class EventsOkState implements EventsState {
  const EventsOkState({required final  List<EventShortModel> events}): _events = events;
...
class EventsLoadingState implements EventsState {
  const EventsLoadingState({required final  List<EventShortModel> events}): _events = events;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EventsLoadingStateCopyWith<EventsLoadingState> get copyWith => _$EventsLoadingStateCopyWithImpl<EventsLoadingState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EventsLoadingState&&const DeepCollectionEquality().equals(other._events, _events));
}
...
@override
String toString() {
  return 'EventsState.loading(events: $events)';
}
...
/// @nodoc
abstract mixin class $EventsLoadingStateCopyWith<$Res> implements $EventsStateCopyWith<$Res> {
  factory $EventsLoadingStateCopyWith(EventsLoadingState value, $Res Function(EventsLoadingState) _then) = _$EventsLoadingStateCopyWithImpl;
@override @useResult
$Res call({
 List<EventShortModel> events
});
...
/// @nodoc
class _$EventsLoadingStateCopyWithImpl<$Res>
    implements $EventsLoadingStateCopyWith<$Res> {
  _$EventsLoadingStateCopyWithImpl(this._self, this._then);

  final EventsLoadingState _self;
  final $Res Function(EventsLoadingState) _then;

/// Create a copy of EventsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? events = null,}) {
  return _then(EventsLoadingState(
events: null == events ? _self._events : events // ignore: cast_nullable_to_non_nullable
as List<EventShortModel>,
  ));
}
...
class EventsErrorState implements EventsState {
  const EventsErrorState({required final  List<EventShortModel> events, required this.errorMessage}): _events = events;
...
@override @useResult
$Res call({
 List<EventShortModel> events, String errorMessage
});
...
events: null == events ? _self._events : events // ignore: cast_nullable_to_non_nullable
as List<EventShortModel>,errorMessage: null == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
